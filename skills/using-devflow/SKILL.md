...
| `analyzing-over-engineering` | "Simplify this", "Is this over-engineered?", "Too complex", "Reduce complexity", "Too many layers/abstractions" | Scan for over-engineering patterns → deletion test → prioritized findings |
